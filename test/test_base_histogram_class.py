...
class BaseHistogramApp:    
    ...
    def on_selected_column_change(self, selected_column, **trame_scripts):
        print("Detecting a change in selected_column...")
        ...
        if self.server.state.selected_column and selected_column:
            try:
                ...
                print("This should be appearing", self.np_data)
            ...
            print("Did not find file_input, selected_column or selected_column.")
    ...
    def compute_dataset(self, selected_dataset, **trame_scripts):
        ...
        try:
            ...
            self.computed_df = df
            print("Type of computed_df:", type(self.computed_df))
            ...
            selected_column_data = self.compute_with_threads(selected_column_data)
            print("Type of selected_column_data:", type(selected_column_data))
            print("Selected column data:", selected_column_data)

            self.np_data = selected_column_data

            print("Size of np_data:", len(self.np_data))
