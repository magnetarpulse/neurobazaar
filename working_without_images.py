...
class BaseOoDHistogram:
    ...
    def __init__(self, name, port, csv_path = "", collection_path="",max_slices="",data_column = None, item_column=None,node_id=None):
        ...
        self.file_manager = LocalFileManager(base_path="/home/cc/research_tests/lidc_pixConvImg")
        self.server.state.image_cache = {} 
        self.image_cache = {}
    ...
    def display_data(self):
        ...
        for i, item in enumerate(self.state.subset_items):
            ...
            items = {
                ...
                "image_row": [f"{self.image_server_url}/{Path(nodule_id).name}" for nodule_id in nodule_ids]
            }
        ...
        if self.state.subset_items:
            ...
            if last_threshold<= max_value:
                ...
                remaining_item = {
                    ...
                    "image_row": [f"{self.image_server_url}/{Path(nodule_id).name}" for nodule_id in remaining_nodule_ids]
                }
                                                ...
                                                '''with vuetify.VRow():
                                                    ...
                                                    with vuetify.Template(v_for="(img, imgIndex) in item.image_row", key="imgIndex"):
                                                        with vuetify.VCol(cols="auto"):
                                                            vuetify.VImg(
                                                            src=("img", lambda name: f"{self.image_server_url}/{img}"),
                                                            alt="Img",
...
if __name__ == "__main__":
    server = BaseOoDHistogram("Ood Analyzer using Trame-Matplotlib", 8088, "/home/cc/research_tests/MaxSlices_wOoDScore.csv", "/home/cc/research_tests/LIDC_Dataset", "/home/cc/research_tests/lidc_pixConvImg", "Log_Loss_ALL","imageSOP_UID","noduleID")
