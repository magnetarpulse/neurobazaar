...
def on_file_input_change(file_input, **kwargs):
    if file_input:
        try:
            ...
            start_time_for_pandas = time.time() # For testing performance
            df = pd.read_csv(BytesIO(content))
            end_time_for_pandas = time.time() # For testing performance
            print(f"Pandas read_csv took {end_time_for_pandas - start_time_for_pandas} seconds") # For testing performance
