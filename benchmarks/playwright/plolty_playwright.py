            ...
            try:
                ...
                result_handle = page.wait_for_function(
                    ...
                    () => {
                        ...
                        const plotlyPlot = document.querySelector('.js-plotly-plot');
                        if (!plotlyPlot) return false;

                        const previousState = window.__previous_plotly_state || null;
                        const currentState = {
                            innerHTML: plotlyPlot.innerHTML,
                            attributes: Array.from(plotlyPlot.attributes).reduce((acc, attr) => {
                        ...
                        window.__previous_plotly_state = currentState;
