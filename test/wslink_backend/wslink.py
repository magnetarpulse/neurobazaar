...
# Define your authentication key here
AUTH_KEY = "key"

# -----------------------------------------------------------------------------
# Validates the request, checks if the key is present and valid, and IP address
# -----------------------------------------------------------------------------
...
async def _root_handler(request):
    ...
    logger.info(f"Peername: {peername}")
    ...
    logger.info(f"Request received with key: {key}")
    ...
    logger.error("Access Denied: Invalid or missing key.")
